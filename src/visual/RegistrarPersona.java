...
public class RegistrarPersona extends JDialog {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (mode == 0) {
                    if (camposGeneralesVacios()) {
                        JOptionPane.showMessageDialog(null, "A�n faltan campos generales por rellenar");
                        return;
                    }
                    ...
                    if (user.getTipo().equals("Administrador")) {
                        if (medicoRadio.isSelected()) {
                            if (camposMedicoVacios()) {
                                JOptionPane.showMessageDialog(null, "A�n faltan campos del m�dico por rellenar");
                                return;
                            }
                            registrarMedico();
                            return;
    ...
    private void registrarMedico() {
        if (!camposGeneralesVacios() && !camposMedicoVacios()) {
            ...
            JOptionPane.showMessageDialog(null, "Usuario generado: " + usuario.getUserName() + " Contrase�a: " + usuario.getPass());
            clean();
